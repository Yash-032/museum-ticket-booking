...
export interface IMongoStorage {
  ...
  getExhibition(id: string): Promise;
  getAllExhibitions(): Promise<any[]>;
  getFeaturedExhibitions(): Promise<any[]>;
  createExhibition(exhibition: InsertExhibition): Promise;
  updateExhibition(id: string, exhibition: InsertExhibition): Promise;
  deleteExhibition(id: string): Promise;

  // Ticket type operations
  getTicketType(id: string): Promise;
  getAllTicketTypes(): Promise<any[]>;
  createTicketType(ticketType: InsertTicketType): Promise;
  updateTicketType(id: string, ticketType: InsertTicketType): Promise;
  deleteTicketType(id: string): Promise;

  // Ticket operations
  getTicket(id: string): Promise;
  getAllTickets(): Promise<any[]>;
  getTicketsByUserId(userId: string): Promise<any[]>;
  createTicket(ticket: InsertTicket & { userId: string; ticketTypeId: string; exhibitionId?: string }): Promise;
  markTicketAsPaid(id: string, paymentIntentId: string): Promise;
  generateQRCode(id: string): Promise;
  markTicketAsUsed(id: string): Promise;

  // Conversation operations
  getConversation(id: string): Promise;
  createConversation(conversation: InsertConversation & { userId?: string }): Promise;

  // Message operations
  createMessage(message: InsertMessage & { conversationId: string }): Promise;
  getMessagesByConversationId(conversationId: string): Promise<any[]>;

  // Analytics operations
  getAnalytics(): Promise<any[]>;
  createAnalyticsEntry(analytics: InsertAnalytics & { popularExhibitionId?: string }): Promise;

  // Testimonial operations
  getApprovedTestimonials(): Promise<any[]>;
  createTestimonial(testimonial: InsertTestimonial): Promise;
  approveTestimonial(id: string): Promise;
...
export class MongoDBStorage implements IMongoStorage {
        ...
        const testimonials = [
          {
            name: 'John Smith',
            role: 'Art Enthusiast',
            content: 'Absolutely amazing experience! The Ancient Egypt exhibition w.',
            rating: 5,
  ...
  async createUser(userData: InsertUser & { isAdmin?: boolean }): Promise {
    try {
  ...
  async deleteExhibition(id: string): Promise {
    try {
...
export class StorageAdapter implements IStorage {
  ...
  async createTicketType(ticketType: InsertTicketType): Promise {
  ...
  async createConversation(conversation: { sessionId: string; language?: string; userId?: number | null }): Promise {
    ...
    const mongoConversation = await this.mongoStorage.createConversation(mongoConversationData );
    return this.convertMongoConversationToConversation(mongoConversation);
  }

  // Message operations with type conversion
  async createMessage(message: { conversationId: number; isFromUser: boolean; content: string }): Promise {
  ...
  async createAnalyticsEntry(analytics: { date: Date; visitorCount: number; revenue: number; popularExhibitionId?: number | null; averageVisitDuration?: number | null }): Promise {
    ...
    const mongoAnalytics = await this.mongoStorage.createAnalyticsEntry(mongoAnalyticsData );
  ...
  async createTestimonial(testimonial: InsertTestimonial): Promise {
