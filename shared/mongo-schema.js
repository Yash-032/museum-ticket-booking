...
export const Exhibition = mongoose.models.Exhibition  || model('Exhibition', exhibitionSchema);
...
export const TicketType = mongoose.models.TicketType  || model('TicketType', ticketTypeSchema);
...
export const Analytics = mongoose.models.Analytics  || model('Analytics', analyticsSchema);
...
export const Testimonial = mongoose.models.Testimonial  || model('Testimonial', testimonialSchema);

// Zod Schem Validation
