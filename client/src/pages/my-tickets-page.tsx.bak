...
import { Ticket as TicketIcon, Calendar, AlertCircle } from "lucide-react";
...
const MyTicketsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t("meta.myTicketsTitle")} | MuseumTix</title>
      </Helmet>
        ...
        <Tabs defaultValue="upcoming" className="w-full">
          ...
          <TabsContent value="upcoming">
            {isLoadingTickets ? (
              ...
              <Card>
                <CardHeader>
                  <CardTitle>{t("myTickets.noUpcomingTickets")}</CardTitle>
                  <CardDescription>{t("myTickets.noTicketsDesc")}</CardDescription>
                </CardHeader>
          ...
          <TabsContent value="past">
            {isLoadingTickets ? (
              ...
              <Card>
                <CardHeader>
                  <CardTitle>{t("myTickets.noPastTickets")}</CardTitle>
                  <CardDescription>{t("myTickets.noPastTicketsDesc")}</CardDescription>
                </CardHeader>
                <CardContent className="flex flex-col items-center justify-center py-12">
                  <TicketIcon className="h-16 w-16 text-neutral-300 mb-4" />
                  <p className="text-neutral-500 mb-6 text-center max-w-md">
      ...
      <AlertDialog open={ticketToCancel !== null} onOpenChange={(open) => !open && setTicketToCancel(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel>{t("myTickets.keepTicket")}</AlertDialogCancel>
            <AlertDialogAction 
