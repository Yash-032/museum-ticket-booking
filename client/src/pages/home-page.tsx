...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    if (chatbotButton && chatbotLauncher) {
      chatbotButton.addEventListener("click", () => {
        (chatbotLauncher as HTMLButtonElement).click();
      });
    }
  ...
  return (
    <>
      <Helmet>
        <title>{t("meta.homeTitle")} | MuseumTix</title>
                  ...
                  <div className="h-96 overflow-y-auto p-4 space-y-4">
                    <div className="flex items-start">
                      <div className="bg-primary-600 text-white rounded-lg py-2 px-4 max-w-xs">
                        <p>{t("chatbot.demoMessage1")}</p>
                      </div>
                    </div>
                    
                    <div className="flex items-start justify-end">
                      <div className="bg-neutral-100 rounded-lg py-2 px-4 max-w-xs">
                        <p>{t("chatbot.demoReply1")}</p>
                      </div>
                    </div>
                    
                    <div className="flex items-start">
                      <div className="bg-primary-600 text-white rounded-lg py-2 px-4 max-w-xs">
                        <p>{t("chatbot.demoMessage2")}</p>
                      </div>
                    </div>
                    
                    <div className="flex items-start justify-end">
                      <div className="bg-neutral-100 rounded-lg py-2 px-4 max-w-xs">
                        <p>{t("chatbot.demoReply2")}</p>
                      </div>
                    </div>
                    
                    <div className="flex items-start">
                      <div className="bg-primary-600 text-white rounded-lg py-2 px-4 max-w-xs">
                        <p>{t("chatbot.demoMessage3")}</p>
                      </div>
                    </div>
                  </div>
