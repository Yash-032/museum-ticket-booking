...
const PaymentForm = ({
  ...
  return (
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-between py-2">
          {t("checkout.tax")}</span>
          ${(totalAmount * 0.0).toFixed(2)}</span>
        </div>
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          <FormField
            ...
            render={({ field }) => (
                ...
                {t("checkout.nameOnCard")}</FormLabel>
          ...
          <FormField
            ...
            render={({ field }) => (
                ...
                {t("checkout.cardNumber")}</FormLabel>
          ...
          <div className="grid grid-cols-3 gap-4">
            <FormField
              ...
              render={({ field }) => (
                  ...
                  {t("checkout.expiryMonth")}</FormLabel>
            ...
            <FormField
              ...
              render={({ field }) => (
                  ...
                  {t("checkout.expiryYear")}</FormLabel>
