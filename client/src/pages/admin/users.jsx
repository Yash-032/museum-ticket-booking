...
const AdminUsers = () => {
  ...
  const updateUserMutation = useMutation({
    mutationFn: async (data: { id: number; user: Partial }) => {
  ...
  return (
    <div className="flex h-screen bg-neutral-100">
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
            ...
            {t("admin.addNewUser")}</DialogTitle>
            {t("admin.addNewUserDescription")}</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
            ...
            {t("admin.editUser")}</DialogTitle>
            {t("admin.editUserDescription")}</DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
            ...
            {t("admin.confirmDeleteUser")}</AlertDialogTitle>
