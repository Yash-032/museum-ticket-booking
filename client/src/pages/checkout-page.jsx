...
const CheckoutPage = () => {
  ...
  // Fetch ticket type
  const { data: ticketType } = useQuery({
    ...
    return (
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-xl mx-auto">
            ...
            {t("checkout.invalidCheckout")}</CardTitle>
            {t("checkout.invalidCheckoutDesc")}</CardDescription>
          </CardHeader>
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-xl mx-auto">
          <CardHeader className="text-center">
            ...
            {t("checkout.paymentSuccessTitle")}</CardTitle>
            {t("checkout.paymentSuccessDesc")}</CardDescription>
          </CardHeader>
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-xl mx-auto">
          <CardHeader className="text-center">
            ...
            {t("checkout.paymentErrorTitle")}</CardTitle>
            {t("checkout.paymentErrorDesc")}</CardDescription>
          </CardHeader>
          <CardContent className="text-center">
  ...
  return (
    <>
        ...
        {t("meta.checkoutTitle")} | MuseumTix</title>
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-xl mx-auto">
              ...
              {t("checkout.paymentDetails")}</CardTitle>
              {t("checkout.paymentDescription")}</CardDescription>
            </CardHeader>
