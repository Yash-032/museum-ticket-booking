  ...
  return (
    <div className="flex h-screen bg-neutral-100">
      ...
      <div className="flex-1 overflow-y-auto">
          ...
          {t("admin.analytics")} | MuseumTix</title>
        </Helmet>
          ...
          <Tabs defaultValue="visitors" className="w-full">
            ...
            <TabsContent value="visitors">
                ...
                <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    {t("admin.visitorsByDay")}</CardTitle>
                    {t("admin.visitorTrends")}</CardDescription>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setVisitorsPeriod(value )}
                    >
            ...
            <TabsContent value="revenue">
                ...
                <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    {t("admin.revenueByDay")}</CardTitle>
                    {t("admin.revenueTrends")}</CardDescription>
                  </div>
            ...
            <TabsContent value="exhibitions">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {t("admin.exhibitionPopularity")}</CardTitle>
                    {t("admin.popularExhibitionsDescription")}</CardDescription>
                  </CardHeader>
                    ...
                    {t("admin.visitorsPerExhibition")}</CardTitle>
                    {t("admin.exhibitionDistribution")}</CardDescription>
                  </CardHeader>
            ...
            <TabsContent value="sales">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <CardHeader className="flex flex-row items-center justify-between">
                      ...
                      {t("admin.ticketSalesByType")}</CardTitle>
                      {t("admin.ticketTypeDistribution")}</CardDescription>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Select
                        value={salesPeriod}
                        onValueChange={(value) => setSalesPeriod(value )}
                      >
                        <SelectTrigger className="w-32">
                          <SelectValue placeholder={t("admin.period")} />
                        </SelectTrigger>
                    ...
                    {t("admin.salesByTicketType")}</CardTitle>
                    {t("admin.ticketTypeComparison")}</CardDescription>
                  </CardHeader>
