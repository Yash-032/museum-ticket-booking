    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("tickets.selectTicket")}</FormLabel>
              <Select
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("tickets.exhibition")}</FormLabel>
              <Select
                value={field.value?.toString() || ""}
                onValueChange={(value) => 
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("tickets.quantity")}</FormLabel>
              <FormControl>
                <Input
                  type="number"
                  min={1}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col">
                <FormLabel>{t("tickets.date")}</FormLabel>
                <Popover>
                    ...
                    <FormControl>
                      ...
                      >
                        {field.value ? (
                          ...
                          <span>{t("tickets.selectDate")}</span>
                        )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("tickets.time")}</FormLabel>
                <Select
                  value={field.value}
