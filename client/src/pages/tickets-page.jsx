...
const TicketsPage = () => {
  ...
  return (
    <>
        ...
        {t("meta.ticketsTitle")} | MuseumTix</title>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            {selectedTicketType ? (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                      ...
                      {t("tickets.ticketDetails")}</CardTitle>
                    </CardHeader>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start">
                        <CalendarIcon className="h-5 w-5 text-primary-600 mr-2 mt-0.5" />
                          ...
                          <ul className="text-neutral-600 space-y-1 text-sm">
                            • Weekday mornings are less crowded</li>
                            • Plan at least 2 hours for your visit</li>
                            • Audio guides are available for rent</li>
                            • Photography without flash is permitted</li>
                          </ul>
                        </div>
                      </div>
                    </div>
          ...
          <TabsContent value="group">
                ...
                {t("tickets.groupVisits")}</CardTitle>
              </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                      <div className="bg-neutral-50 p-4 rounded-lg">
                        ...
                        <ul className="space-y-1 text-neutral-600 text-sm">
                          • Special educational rates</li>
                          • Customized learning materials</li>
                          • Grade-specific guided tours</li>
                          • Lunch area reservation option</li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-neutral-50 p-4 rounded-lg">
                        ...
                        <ul className="space-y-1 text-neutral-600 text-sm">
                          • 15% discount for groups of 10-20</li>
                          • 20% discount for groups over 20</li>
                          • Private guided tours available</li>
                          • Special exhibition access</li>
                        </ul>
                      </div>
                    </div>
